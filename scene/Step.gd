...
func _draw() -> void:
	...
	if step.upper_body_rotation != 0:
		draw_upper_body_rotation()
...
func draw_upper_body_rotation():
	draw_rotation(Vector2(0, -1.75), step.upper_body_rotation)


func draw_body_rotation():
	draw_rotation(Vector2(0, 2.5), step.body_rotation)
